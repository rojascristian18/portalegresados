			...
			<div class="table-responsive">
				<table class="table">
					...
					<tbody>
						...
						<tr>
							<td><?= h($estudioUsuario['EstudioUsuario']['nombre']); ?>&nbsp;</td>
							<td><?= h($estudioUsuario['EstudioUsuario']['activo']); ?>&nbsp;</td>
							<td><?= h($estudioUsuario['EstudioUsuario']['empleo_count']); ?>&nbsp;</td>
							<td><?= h($estudioUsuario['EstudioUsuario']['empleo_activo_count']); ?>&nbsp;</td>
							<td><?= h($estudioUsuario['EstudioUsuario']['created']); ?>&nbsp;</td>
							<td>
