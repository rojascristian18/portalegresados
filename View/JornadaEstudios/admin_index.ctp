<div class="page-title">
	<h2><span class="fa fa-list"></span> Jornada Estudios</h2>
</div>

<div class="page-content-wrap">
	<div class="panel panel-default">
		<div class="panel-heading">
			<h3 class="panel-title">Listado de Jornada Estudios</h3>
			<div class="btn-group pull-right">
				<?= $this->Html->link('<i class="fa fa-plus"></i> Nuevo Jornada Estudio', array('action' => 'add'), array('class' => 'btn btn-success', 'escape' => false)); ?>
		...
		<div class="panel-body">
			<div class="table-responsive">
				<table class="table">
					...
					<tbody>
						<?php foreach ( $jornadaEstudios as $jornadaEstudio ) : ?>
						<tr>
							...
							<td>
								...
								<?= $this->Form->postLink('<i class="fa fa-remove"></i> Eliminar', array('action' => 'delete', $jornadaEstudio['JornadaEstudio']['id']), array('class' => 'btn btn-xs btn-danger confirmar-eliminacion', 'rel' => 'tooltip', 'title' => 'Eliminar este registro', 'escape' => false)); ?>
							</td>
						</tr>
						<?php endforeach; ?>
					</tbody>
