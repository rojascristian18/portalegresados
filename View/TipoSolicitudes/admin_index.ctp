...
<div class="page-content-wrap">
	<div class="panel panel-default">
		<div class="panel-heading">
			<h3 class="panel-title">Listado de Tipo Solicitudes</h3>
			<div class="btn-group pull-right">
				<?= $this->Html->link('<i class="fa fa-plus"></i> Nuevo Tipo Solicitud', array('action' => 'add'), array('class' => 'btn btn-success', 'escape' => false)); ?>
		...
		<div class="panel-body">
			<div class="table-responsive">
				<table class="table">
					<thead>
						<tr class="sort">
							<th><?= $this->Paginator->sort('tipo_solicitud', null, array('title' => 'Haz click para ordenar por este criterio')); ?></th>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<?= $this->Form->postLink('<i class="fa fa-remove"></i> Eliminar', array('action' => 'delete', $tipoSolicitud['TipoSolicitud']['id']), array('class' => 'btn btn-xs btn-danger confirmar-eliminacion', 'rel' => 'tooltip', 'title' => 'Eliminar este registro', 'escape' => false)); ?>
							</td>
						</tr>
						<?php endforeach; ?>
					</tbody>
