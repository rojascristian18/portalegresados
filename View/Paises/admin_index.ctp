	...
	<div class="panel panel-default">
		<div class="panel-heading">
			...
			<div class="btn-group pull-right">
				<?= $this->Html->link('<i class="fa fa-plus"></i> Nuevo Paise', array('action' => 'add'), array('class' => 'btn btn-success', 'escape' => false)); ?>
				...
				<table class="table">
					<thead>
						<tr class="sort">
							...
							<th><?= $this->Paginator->sort('codigo_pais', null, array('title' => 'Haz click para ordenar por este criterio')); ?></th>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<?= $this->Form->postLink('<i class="fa fa-remove"></i> Eliminar', array('action' => 'delete', $paise['Paise']['id']), array('class' => 'btn btn-xs btn-danger confirmar-eliminacion', 'rel' => 'tooltip', 'title' => 'Eliminar este registro', 'escape' => false)); ?>
							</td>
						</tr>
						<?php endforeach; ?>
					</tbody>
