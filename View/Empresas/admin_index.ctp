				...
				<table class="table">
					<thead>
						<tr class="sort">
							...
							<th><?= $this->Paginator->sort('rut_empresa', null, array('title' => 'Haz click para ordenar por este criterio')); ?></th>
							<th>Acciones</th>
						</tr>
					</thead>
					<tbody>
						...
						<tr>
							<td><?= $this->Html->link($empresa['RubroEmpresa']['nombre'], array('controller' => 'rubro_empresas', 'action' => 'edit', $empresa['RubroEmpresa']['id'])); ?></td>
							...
							<td><?= h($empresa['Empresa']['rut_empresa']); ?>&nbsp;</td>
							<td>
