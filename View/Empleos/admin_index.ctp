				...
				<table class="table">
					<thead>
						<tr class="sort">
							...
							<th><?= $this->Paginator->sort('cargo_id', null, array('title' => 'Haz click para ordenar por este criterio')); ?></th>
					...
					<tbody>
						...
						<tr>
							...
							<td><?= $this->Html->link($empleo['Cargo']['nombre'], array('controller' => 'cargos', 'action' => 'edit', $empleo['Cargo']['id'])); ?></td>
							<td><?= $this->Html->link($empleo['Jornada']['nombre'], array('controller' => 'jornadas', 'action' => 'edit', $empleo['Jornada']['id'])); ?></td>
							<td><?= $this->Html->link($empleo['TipoContrato']['nombre'], array('controller' => 'tipo_contratos', 'action' => 'edit', $empleo['TipoContrato']['id'])); ?></td>
