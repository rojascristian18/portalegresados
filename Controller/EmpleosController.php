...
class EmpleosController extends AppController
{
	...
	public function admin_add()
	{
		...
		$cargos	= $this->Empleo->Cargo->find('list');
		$jornadas	= $this->Empleo->Jornada->find('list');
		$tipoContratos	= $this->Empleo->TipoContrato->find('list');
		$comunas	= $this->Empleo->Comuna->find('list');
		$experiencias	= $this->Empleo->Experiencia->find('list');
		$estadoEmpleos	= $this->Empleo->EstadoEmpleo->find('list');
		$estudioUsuarios	= $this->Empleo->EstudioUsuario->find('list');
		$categorias	= $this->Empleo->Categoria->find('list');
		$this->set(compact('empresas', 'cargos', 'jornadas', 'tipoContratos', 'comunas', 'experiencias', 'estadoEmpleos', 'estudioUsuarios', 'categorias'));
	}
